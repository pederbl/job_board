...
(function($) {
    ...
    DynaTreeNode.prototype = {
        ...
        _expand: function(bExpand, forceSync) {
            ...
            var allowEffects = !(this.data.isLazy && this.childList === null) && !this.isLoading && !forceSync;
    ...
    DynaTree.prototype = {
        ...
        _setDndStatus: function(sourceNode, targetNode, helper, hitMode, accept) {
            ...
            if (!this.$dndMarker) {
                this.$dndMarker = $("<div id='dynatree-drop-marker'></div>").hide().prependTo($(this.divTree).parent());
            }
...
c.close);b.closeOnClick&&a(document).bind("click."+n,function(l){if(a(l.target).parent().length > 0 && a(l.target).parents(f).length == 0) { c.close(l); } });b.closeOnEsc&&a(document).bind("keydown."+n,function(l){l.keyCode==27&&c.close(l)});return c},close:function(e){if(!c.isOpened())return c;e=e||a.Event();e.type="onBeforeClose";j.trigger(e);if(!e.isDefaultPrevented()){m=false;q[b.effect][1].call(c,function(){e.type="onClose";j.trigger(e)});a(document).unbind("click."+n).unbind("keydown."+n);g&&a.mask.close();return c}},getOverlay:function(){return f},
